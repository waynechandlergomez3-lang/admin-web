    ...
    <div className="bg-white rounded-xl shadow p-4">
      <div className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3 bg-slate-50 p-3 rounded-lg">
          ...
          >
            ...
            <option value="inactive">In-Used</option>
          </select>
        </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="bg-slate-50"><tr><th className="p-2">ID</th><th className="p-2">Responder</th><th className="p-2">Plate</th><th className="p-2">Vehicle Type</th><th className="p-2">Color</th><th className="p-2">Status</th><th className="p-2">Action</th></tr></thead>
          <tbody>
